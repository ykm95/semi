...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-1">
			<div class="col-md-4"
				style="margin-bottom: 50px; border-right: 1px #ccc solid; height: 1200px;"></div>
			<div class="col-md-4 col-offset-2"></div>
		</div>
		...
		<div class="col-md-8">
			...
			<c:forEach items="${list }" var="i">
				<div class="col-md-6"
					onclick="location.href='/recipe/view?recipeno=${i.recipeno }'">
					<div>
						<img style="margin: 0 auto;" class="thumbnail" width="250px"
							height="250px" src="${i.recipic }">
					</div>
					<div>
						<h3 style="text-align: center;">${i.recipename }</h3>
					</div>
					<div>
						<h4 style="text-align: center;">${i.username }</h4>
					</div>
				</div>
			</c:forEach>

			<form action="/mypage/scrap" method="get">
		...
		<jsp:include page="/WEB-INF/views/mypage/scrap/scrap_paging.jsp" />
