...
@WebServlet("/mypage/question/view")
public class QuestionViewController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Question question = questionService.getQuestionView(req);
		...
		req.getRequestDispatcher("/WEB-INF/views/mypage/question/question_view.jsp")
		.forward(req, resp);
	}
